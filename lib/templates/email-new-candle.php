...
<html>
	...
	<head>
		<title><?php echo sprintf('New Candle | ' . get_option('blogname')); ?></title>
					...
					<table width="90%" align="center">
						<tr>
							<td align="left" valign="top">
								...
								<p>
									A new candle has been submitted on your website located at<br />
									<a href="<?php echo $site_url; ?>"><?php echo $site_url; ?></a>.
								</p>

								<h2><?php echo $_POST['candle_prayer_name']; ?> wrote,</h2>
								...
								<p class="button-parent">
									<a href="<?php echo admin_url( 'post.php?post=' . $candle->ID . '&action=edit' ); ?>" class="button">
										View Now
									</a>
								</p>
